...
좌석 현황은 집계 데이터이지만 실제 도서관 API가 인증 토큰을 요구하므로
`LIBRARY` 연동 후에만 조회합니다. `floor`는 `2`, `5`, `6`만 지원합니다.
...
- **[ssuAI](https://github.com/ghdtjdwn/ssuAI)** - 이 MCP 서버를 소비하는 Next.js 웹/앱 클라이언트
