...
### 비동기 예약 동시성 (intent 큐 · per-seat 분산 락 · SSE)
...
| 인프라 | Oracle Cloud ARM64 · k3s · Traefik · ArgoCD(Image Updater GitOps) · Helm · GHCR(ARM64) · Prometheus/Grafana |
